...
const FEATURE_CARDS = [
  ...
  },
  {
    emoji: "🎯",
    title: "Quiz Yourself",
    body:  "10 questions to lock in what you learned. Track your score.",
...
export default function LandingPage({ onFile, onDemo }: LandingPageProps) {
  return (
    <div className="mobile-container overflow-y-auto">
      ...
      <section className="relative px-5 pt-8 pb-6 text-center">
        ...
        <div className="flex gap-3">
          ...
          <button className="btn-secondary flex-[2] text-sm" onClick={() => document.querySelector<HTMLElement>(".upload-zone")?.click()}>
            📤 Upload
          </button>
        </div>
      ...
      <section className="px-5 pb-6">
        ...
        <div className="grid grid-cols-2 gap-3">
          {FEATURE_CARDS.map(f => (
            <div
              key={f.title}
              className={`rounded-2xl border p-4 ${f.bg}`}
            >
      ...
      <section className="px-5 pb-6">
        ...
        <div className="flex flex-col gap-0">
          {[
            ...
            { step: "4", title: "Quiz yourself",          body: "Lock in what you learned with 10 tailored questions."                  },
          ].map((s, i, arr) => (
